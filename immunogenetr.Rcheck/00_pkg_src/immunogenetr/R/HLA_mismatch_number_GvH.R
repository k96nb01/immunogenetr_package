...
#' in the GvH (Graft vs. Host) direction.
#'
...
HLA_mismatch_number_GvH <- function(GL_string_recip, GL_string_donor, loci, homozygous_count = 2){
  # Call the original HLA_mismatch_number function with "GvH" direction
  return(HLA_mismatch_number(GL_string_recip, GL_string_donor, loci, "GvH", homozygous_count))
}
