...
test_that("HLA_mismatched_alleles correctly identifies mismatched alleles", {
  ...
  result_HvG <- HLA_mismatched_alleles(GL_string_recip, GL_string_donor, loci, direction = "HvG")
  result_GvH <- HLA_mismatched_alleles(GL_string_recip, GL_string_donor, loci, direction = "GvH")
  result_bidirectional <- HLA_mismatched_alleles(GL_string_recip, GL_string_donor, loci, direction = "bidirectional")
  result_SOT <- HLA_mismatched_alleles(GL_string_recip, GL_string_donor, loci, direction = "SOT")
  ...
  result_single_locus <- HLA_mismatched_alleles(GL_string_recip, GL_string_donor, "HLA-A", direction = "HvG")
  expect_equal(result_single_locus, "HLA-A*03:01")

  result_homozygous_1 <- HLA_mismatched_alleles(GL_string_recip, GL_string_donor, "HLA-B", direction = "HvG", homozygous_count = 1)
  expect_equal(result_homozygous_1, "HLA-B*44:02")

  result_homozygous_2 <- HLA_mismatched_alleles(GL_string_recip, GL_string_donor, "HLA-B", direction = "HvG", homozygous_count = 2)
