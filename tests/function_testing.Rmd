...
HLA_mismatch_base <- function(GL_string_recip, GL_string_donor, loci, direction = c("HvG", "GvH"), homozygous_count = 2) {
  ...
  process_pair <- function(recip_str, donor_str) {
    ...
    mismatch_results <- map(loci, function(locus_name) {
      ...
      # Identify mismatched alleles based on direction and exclude null alleles
      mismatched_alleles <- c()
      ...
      # Filter out null alleles from mismatched alleles.
      mismatched_alleles <- mismatched_alleles[!str_detect(mismatched_alleles, "[Nn]$")]
...
HLA_mismatch_base(
  "HLA-A*03:01+HLA-A*74:01N^HLA-B*53:01+HLA-B*57:03^HLA-C*04:01+HLA-C*07:01^HLA-DRB1*11:01+HLA-DRB1*16:02N^HLA-DRB3*03:01^HLA-DRB5*02:21^HLA-DQA1*01:02+HLA-DQA1*05:05^HLA-DQB1*03:19+HLA-DQB1*05:02^HLA-DPA1*02:01+HLA-DPA1*02:02^HLA-DPB1*01:01", 
  "HLA-A*03:01+HLA-A*30:02^HLA-B*14:02^HLA-C*08:02^HLA-DRB1*01:02+HLA-DRB1*13:02^HLA-DRB3*03:01^HLA-DQA1*01:01+HLA-DQA1*01:02^HLA-DQB1*05:01+HLA-DQB1*06:09^HLA-DPA1*02:01^HLA-DPB1*05:01+HLA-DPB1*17:01",
  c("HLA-A", "HLA-DRB1", "HLA-DRB3/4/5"),
  direction = "GvH"
  )
...
HLA_mismatch_base(
  "HLA-A2+HLA-A68^HLA-Cw1+HLA-Cw17^HLA-DR1+HLA-DR17^HLA-DR52^HLA-DPB1*04:01", 
  "HLA-A3+HLA-A69^HLA-Cw10+HLA-Cw9^HLA-DR4+HLA-DR17^HLA-DR52+HLA-DR53N^HLA-DPB1*04:01+HLA-DPB1*04:02",
  # function works when "HLA-DR51/52/53" is removed
  c("HLA-A", "HLA-Cw","HLA-DR51/52/53", "HLA-DPB1"),
  direction = "HvG"
  )
