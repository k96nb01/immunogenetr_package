...
HLA_mismatch_HvG_alleles("HLA-A*02:01+HLA-A*30:01^HLA-B*15:01", "HLA-A*02:02+HLA-A*68:01^HLA-B*15:01+HLA-B*14:01", c("A", "B"))
```
...
HLA_mismatch_HvG_number <- function(GL_string_recip, GL_string_donor, loci, homozygous_count = 1) {
  ...
  if (length(missing_loci_names) > 0) {
   ...
   # Iterate over each locus and corresponding allele strings from recipient and donor
   mismatch_results <- map2(loci, seq_along(loci), ~{
     locus_name <- .x
     locus_index <- .y
...
HLA_mismatch_HvG_number("HLA-A*02:01+HLA-A*68:01^HLA-B*15:02+HLA-B*15:01", "HLA-A*03:01+HLA-A*03:01^HLA-B*15:03+HLA-B*15:15", c("A", "B"), homozygous_count = 2)
```
