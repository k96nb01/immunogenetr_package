...
# This does not work as intended. The beginning of the GL string looks good ("HLA-A2^HLA-B7+HLA-B18"), but then the Bw typings are included in the B locus part of the string ("HLA-B7+HLA-B18+HLA-B6+HLA-B6). This part of the string should be "HLA-B7+HLA-B18^HLA-Bw6+HLA-Bw6". Also, using the `serologic = TRUE` argument in the function means that the end of the string improperly records the molecular nomencatlure ("HLA-DQA105:01:01+HLA-DQA104:01:01" should be "HLA-DQA1*05:01:01+HLA-DQA1*04:01:01"). Also, the DR and DQ typing is not correct: "HLA-DR117^HLA-DR28" should be "HLA-DR17^HLA-DR8". I think we need to update the HLA_columns_to_GLstring function to deal with serologic nomenclature properly.
```
