...
(test_b <- tribble(
  ~case, ~"A1", ~"A2", ~"DRBX1", ~"DRBX2", ~"E1", ~"E2", ~"MICB1", ~"MICA2", ~"TAP11", ~"TAP22", ~"HFE1", ~"HFE2", ~"mO1Cd.recipient",
...
#(test_b %>% HLA_columns_to_GLstring(case, c(A1:mO1Cd.recipient), prefix_to_remove = "m", suffix_to_remove = "Cd.recipient"))
```
