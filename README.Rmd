...
output:
  github_document:
    ...
    # of being wrapped in <sup> HTML tags. Disable 'subscript' for the
    # same reason: GL Strings use '~' as a phasing delimiter, which pandoc
    # would otherwise interpret as subscript markup.
