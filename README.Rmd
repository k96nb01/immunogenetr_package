...
# kable_hla(): wrap knitr::kable with per-cell escaping of the HLA
# metacharacters '*' and '^'. GitHub's markdown renderer (GFM) treats
# '*' pairs inside pipe-table cells as italic markers and '^' pairs as
# superscript (via pandoc's intermediate step). Escaping them to '\*' and
# '\^' produces literal output on GitHub without affecting other renderers.
#
