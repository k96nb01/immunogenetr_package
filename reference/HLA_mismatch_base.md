...
to be called directly; it is better to use one of the derivative
functions.
...
- direction:
  ...
  "HvG" (host vs. graft) or "GvH" (graft vs. host).
...
- homozygous_count:
  ...
  calculations. Can be specified to be 1, in which case homozygous
