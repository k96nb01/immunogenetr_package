#' @title HLA_match_number_HvG
#'
#' @description Calculates the number of HLA matches in the HvG direction as two
...
HLA_match_number_HvG <- function(GL_string_recip, GL_string_donor, loci){
  HLA_match_number(GL_string_recip, GL_string_donor, loci, "HvG")
}
