#' @title HLA_match_number_bidirectional
#'
#' @description Calculates the number of HLA matches bidirectionally as two
...
HLA_match_number_bidirectional <- function(GL_string_recip, GL_string_donor, loci){
  HLA_match_number(GL_string_recip, GL_string_donor, loci, "bidirectional")
}
