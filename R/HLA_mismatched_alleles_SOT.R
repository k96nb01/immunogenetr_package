#' @title HLA_mismatched_alleles_SOT
#'
...
#' direction, used for determining mismatches in solid organ transplantation (SOT).
#'
...
#' HLA_mismatched_alleles_SOT(GL_string_recip, GL_string_donor, loci)
#'
#'
#' @export
#'
...
HLA_mismatched_alleles_SOT <- function(GL_string_recip, GL_string_donor, loci, homozygous_count = 2) {
  HLA_mismatched_alleles(GL_string_recip, GL_string_donor, loci, "HvG", homozygous_count)
}
