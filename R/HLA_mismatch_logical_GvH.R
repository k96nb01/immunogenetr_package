...
#' any mismatches between recipient and donor in the graft-versus-host direction.
...
HLA_mismatch_logical_GvH <- function(GL_string_recip, GL_string_donor, loci) {
  HLA_mismatch_logical(GL_string_recip, GL_string_donor, loci, "GvH")
}
