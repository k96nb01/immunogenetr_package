#' @title HLA_mismatched_alleles_bidirectional
#'
#' @description A wrapper for the `HLA_mismatched_alleles` function: returns a string
#' of mismatches between recipient and donor HLA genotypes in both the host-versus-graft
#' and graft-versus-host directions.
#'
...
#' HLA_mismatched_alleles_bidirectional(GL_string_recip, GL_string_donor, loci)
#'
#'
#' @export
#'
...
HLA_mismatched_alleles_bidirectional <- function(GL_string_recip, GL_string_donor, loci, homozygous_count = 2) {
  HLA_mismatched_alleles(GL_string_recip, GL_string_donor, loci, "bidirectional", homozygous_count)
}
