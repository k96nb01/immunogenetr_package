...
#'
#' @description A wrapper for `HLA_mismatch_number_HvG`: calculates the number of mismatched
#' HLA alleles between a recipient and a donor across specified loci in the host-vs-graft
#' (HvG) direction, used for determining mismatches in solid organ transplantation (SOT).
#'
...
HLA_mismatch_number_SOT <- function(GL_string_recip, GL_string_donor, loci, homozygous_count = 2){
  HLA_mismatch_number_HvG(GL_string_recip, GL_string_donor, loci, homozygous_count)
}
