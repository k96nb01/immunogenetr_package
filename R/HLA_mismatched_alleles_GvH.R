...
#'
#' @description A function that checks for alleles in the recipient that are not present in the donor
...
#' "HLA-A*02:01+HLA-A*02:01") are both assumed to indicate two identical alleles at the A locus.
